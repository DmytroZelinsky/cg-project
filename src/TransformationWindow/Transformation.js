...
const Transformation = (props) => {
	...
	const draw = (p5) => {
        ...
        p5.noFill()
        p5.beginShape();
        p5.vertex(points[0][0] * price, points[0][1] * price);
        p5.vertex(points[1][0] * price, points[1][1] * price);
        p5.vertex(points[2][0] * price, points[2][1] * price);
        p5.vertex(points[3][0] * price, points[3][1] * price);
        p5.vertex(points[0][0] * price, points[0][1] * price);
        p5.endShape();
        p5.fill('red')
        p5.noStroke()
        p5.circle(points[0][0] * price, points[0][1] * price, 10)
        p5.circle(points[1][0] * price, points[1][1] * price, 10)
	};
